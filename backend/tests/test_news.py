...
def test_sort_by_teams():
    ...
    items = [
        SimpleNamespace(id=1, team_tags=["法国"], published_at=None),
        SimpleNamespace(id=2, team_tags=["阿根廷"], published_at=None),
        SimpleNamespace(id=3, team_tags=None, published_at=None),
    ]
